    ...
    const NavBlocks = (
        <SidebarItems>
          ...
          <span className="flex items-center gap-2">
            ...
            <SidebarItemGroup>
                <SidebarCollapse icon={FaGamepad} label="빙고 게임">
                    {bingoRoutes.map(({path, label}) => (
                        <SidebarItem
                            key={path}
                            as={Link}
                            to={path}
        ...
        <>
            ...
            <div className={`md:hidden fixed inset-0 z-50 ${isOpen ? "" : "pointer-events-none"}`}>
                ...
                >
                    {/* Header */}
                    <div
                        className="shrink-0 px-4 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
