...
const Post3 = () => {
    return (
        <div className="prose prose-lg max-w-4xl mx-auto px-4 dark:prose-invert leading-relaxed tracking-wide">
            ...
            <LightboxViewer src="blogs/post3/1.png" alt="IAM 검색 및 진입" />
            ...
            <LightboxViewer src="blogs/post3/2.png" alt="사용자 추가 화면" />
            <LightboxViewer src="blogs/post3/3.png" alt="사용자 생성 화면" />
            ...
            <LightboxViewer src="blogs/post3/4.png" alt="사용자 이름 및 액세스 방식" />
            ...
            <LightboxViewer src="blogs/post3/5.png" alt="권한 정책 연결" />
            <LightboxViewer src="blogs/post3/6.png" alt="권한 정책 연결2" />
            ...
            <LightboxViewer src="blogs/post3/7.png" alt="검토 후 사용자 생성" />
            ...
            <LightboxViewer src="blogs/post3/8.png" alt="엑세스 키 생성" />
            <LightboxViewer src="blogs/post3/9.png" alt="설명 태그 설정 - 선택 사항" />
            <LightboxViewer src="blogs/post3/10.png" alt="액세스 키 검색" />
