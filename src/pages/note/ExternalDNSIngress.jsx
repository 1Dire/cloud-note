...
const ExternalDNSIngress = () => {
    ...
    return (
        <section className="space-y-6 text-gray-800 dark:text-gray-200">
            ...
            <h2 className="text-xl font-semibold">🔍 동작 흐름</h2>
            ...
            <h2 className="text-xl font-semibold">🧩 Ingress 예시 (호스트 기반 라우팅)</h2>
      ...
      http:
        paths:
          - path: /
            ...
            <h2 className="text-xl font-semibold">🧭 경로 기반 라우팅 예시</h2>
            <BlockCode language="yaml">
                {`apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
      ...
      http:
        paths:
          ...
          - path: /v2
            ...
            <h2 className="text-xl font-semibold">🔧 ExternalDNS 연동 포인트</h2>
