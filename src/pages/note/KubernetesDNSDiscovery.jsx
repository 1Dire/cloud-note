...
const KubernetesDNSDiscovery = () => {
    ...
    return (
        <section className="space-y-4">
            <h1 className="text-2xl font-bold text-indigo-600 dark:text-sky-400">
            ...
            <h2 className="text-xl font-semibold mt-6">🔍 동작 원리</h2>
            ...
            <h2 className="text-xl font-semibold">📂 DNS 이름 구조</h2>
...
myservice.default.svc.cluster.local`}
            ...
            <h2 className="text-xl font-semibold">🛠️ 실습 명령어</h2>
