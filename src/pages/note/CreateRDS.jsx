        ...
        <section className="space-y-8 text-gray-800 dark:text-gray-200">
            ...
            <ol className="list-decimal list-inside space-y-6 pl-2">
                <li>
                    ...
                    <LightboxViewer src="note/createRDS/1.png" alt="RDS 검색 및 진입" />
                </li>

                <li>
                    <strong>데이터베이스 생성 클릭</strong>
                    <p>"데이터베이스 생성" 버튼 클릭</p>
                    <LightboxViewer src="note/createRDS/2.png" alt="데이터베이스 생성 버튼" />
                </li>
                ...
                <li>
                    ...
                    <LightboxViewer src="note/createRDS/3.png" alt="MySQL 프리티어 선택" />
                </li>
                ...
                <li>
                    ...
                    <LightboxViewer src="note/createRDS/4.png" alt="DB 이름 및 사용자 설정" />
                </li>

                <li>
                    <strong>퍼블릭 액세스 설정</strong>
                    <p><InlineCode>퍼블릭 액세스: 아니요</InlineCode> 선택 (보안상 안전)</p>
                    <LightboxViewer src="note/createRDS/5.png" alt="퍼블릭 액세스 설정" />
                </li>
                ...
                <li>
                    ...
                    <LightboxViewer src="note/createRDS/6.png" alt="보안 그룹 설정" />
                </li>

                <li>
                    <strong>데이터베이스 생성</strong>
                    <p>설정 완료 후 <InlineCode>데이터베이스 생성</InlineCode> 클릭</p>
                    <LightboxViewer src="note/createRDS/7.png" alt="DB 생성 버튼" />
                </li>

                <li>
                    <strong>엔드포인트 복사</strong>
                    <p>생성이 완료되면 DB 인스턴스 상세 정보에서 엔드포인트 복사</p>
                    <LightboxViewer src="note/createRDS/8.png" alt="엔드포인트 확인" />
                </li>
            </ol>
        </section>
    );
