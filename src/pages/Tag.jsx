...
const dummyLogs = [{
    ...
    title: "EC2 인스턴스 생성", tags: ["EC2", "키 페어"], to: "createEC2",
}, {
    title: "SSH 접속", tags: ["SSH 접속"], to: "sshConection",
}, {
    title: "AWS RDS 인스턴스 생성", tags: ["RDS", "MySQL", "DB 생성"], to: "createRDS",
}, {
    title: "RDS 인스턴스 연결", tags: ["RDS", "MySQL", "EC2 연동"], to: "rdsConection",
}, {
    title: "도커란 무엇인가", tags: ["Docker", "이미지", "컨테이너", "볼륨", "명령어"], to: "whatIsDocker",
}, {
    title: "쿠버네티스란 무엇인가", tags: ["Kubernetes", "컨테이너", "오케스트레이션", "클러스터", "DevOps"], to: "whatIsKubernetes",
}, {
    title: "쿠버네티스의 파드와 서비스", tags: ["Kubernetes", "Pod", "Service", "로드밸런서", "클러스터"], to: "podAndService",
}, {
    title: "ReplicaSet과 Deployment란?",
    tags: ["Kubernetes", "ReplicaSet", "Deployment", "레플리카", "오케스트레이션"],
    to: "replicaSetAndDeployment",
}, {
    title: "쿠버네티스 핵심 리소스 한눈에 보기", tags: ["Kubernetes", "리소스", "개념정리", "DevOps", "운영"], to: "kubernetesSummary",
}, {
    title: "Kops로 AWS에 쿠버네티스 클러스터 구성하기", tags: ["Kops", "Kubernetes", "AWS", "클러스터", "Vagrant"], to: "kopsOnAWS",
}, {
    ...
    title: "헬스 체크", tags: ["Kubernetes", "Deployment", "헬스체크", "livenessProbe", "프로덕션 안정성"], to: "healthCheck",
}, {
    title: "파드(Pod)의 상태 이해하기",
    tags: ["Kubernetes", "livenessProbe", "readinessProbe", "헬스체크", "서비스 안정성"],
    to: "livenessReadiness",
}, {
    title: "Liveness 와 Readiness Probe", tags: ["Kubernetes", "Pod 상태", "파드 수명주기", "컨테이너 상태", "디버깅"], to: "podStatus",
},
