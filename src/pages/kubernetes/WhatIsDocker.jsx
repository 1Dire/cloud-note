    ...
    return (
        <div className="prose prose-lg max-w-4xl mx-auto px-4 dark:prose-invert leading-relaxed tracking-wide">
            ...
            <div>
                ...
                <BlockCode language="bash" code={`docker build -t myapp .        # 도커 이미지 생성
...
docker rmi [이미지ID]         # 이미지 삭제`} />
            ...
            <div>
                ...
                <BlockCode language="bash" code={`docker cp ./app/config.json mycontainer:/usr/src/app/config.json`} />
            </div>
            ...
            <div>
                ...
                <BlockCode language="bash" code={`docker run -v /host/path:/container/path myapp`} />
            </div>
            ...
            <div>
                ...
                <BlockCode language="bash" code={`docker volume create myvolume

docker run -v myvolume:/app/data myapp`} />
                <BlockCode language="bash" code={`# 볼륨 명령어
create   # 볼륨 생성
inspect  # 상세 정보 확인
ls       # 목록 출력
rm       # 삭제`} />
            ...
            <div>
                ...
                <BlockCode language="dockerfile" code={`FROM node:18-alpine
RUN npm install
COPY . /app
CMD ["node", "app.js"]
EXPOSE 3000
ENV NODE_ENV=production`} />
            ...
            <div>
                ...
                <BlockCode language="yaml" code={`version: '3.8'
services:
  web:
    image: nginx
    ports:
    ...
    environment:
      POSTGRES_PASSWORD: example`} />
            ...
            <div>
                ...
                <BlockCode language="bash" code={`docker-compose up     # 모든 서비스 시작
